...
const PLUGIN_INFO = {
    ...
    description: 'Proxies ComfyUI API calls from the browser through the SillyTavern server to bypass CORS and mixed-content restrictions.',
};
...
function init(router) {
    try {
        ...
        console.log('[ST-BetterImgGen] Plugin loaded — routes mounted at /api/plugins/st-betterimgen');
    } catch (err) {
